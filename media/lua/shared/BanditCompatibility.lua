...
local getGameVersion = function()
    return gameVersion = getCore():getGameVersion():getMajor()
end
...
BanditCompatibility.AddZombiesInOutfit = function(x, y, z, 1, outfit, femaleChance, crawler, isFallOnFront, isFakeDead, knockedDown, isInvulnerable, isSitting, health)
    local zombieList
    if getGameVersion() >= 42 then
