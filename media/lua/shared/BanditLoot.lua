...
BanditLoot.CounterItems = BanditLoot.CounterItems or {}
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.TinnedBeans", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedCarrots2", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedChili", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedCorn", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedCornedBeef", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedFruitCocktail", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedMushroomSoup", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedPeaches", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedPeas", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedPineapple", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedPotato2", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedSardines", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.TinnedSoup", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedBolognese", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedTomato2", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.TunaTin", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedBroccoli", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedCabbage", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedCarrots", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedPotato", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedTomato", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedEggplant", 1))
table.insert(BanditLoot.CounterItems, BanditLoot.MakeItem("Base.CannedBellPepper", 1))

BanditLoot.CrateItems = BanditLoot.CrateItems or {}
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.TinnedBeans", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedCarrots2", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedChili", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedCorn", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedCornedBeef", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedFruitCocktail", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedMushroomSoup", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedPeaches", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedPeas", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedPineapple", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedPotato2", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedSardines", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.TinnedSoup", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedBolognese", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedTomato2", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.TunaTin", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedBroccoli", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedCabbage", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedCarrots", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedPotato", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedTomato", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedEggplant", 1))
table.insert(BanditLoot.CrateItems, BanditLoot.MakeItem("Base.CannedBellPepper", 1))
